...
-- Catálogo: não mora aqui. Os 12 produtos, categorias e faixas são dado versionado
-- da migration `0011_catalogo_seed.sql` — configuração de produto precisa existir
-- em staging e produção, onde o seed nunca chega.
