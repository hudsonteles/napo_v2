...
Arquivos: nenhum de produto — evidência registrada em `tests.md` §F · Testes: T37 · Depende: G · Est: 60min · Agente: inline · `[x]` concluído — **3 de 6 caminhos; 3 viram dívida por limitação da conta de teste (decisão do PM)**
